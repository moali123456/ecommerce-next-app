...
// export function ProductSectionCard({ product }) {
...
//       setRating(product.rating); // fallback to product.rating
//     }
//   }, [product]);

//   return (
//     <div className="p-4 bg-white dark:bg-transparent h-full border border-gray-100 flex flex-col items-center justify-center gap-4 relative">
//       <Image
...
//             {/* ${product?.discountPercentage} */} $200
//           </span>
//         </div>
